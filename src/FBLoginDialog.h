...
@protocol ShareKitFBLoginDialogDelegate;
...
@interface ShareKitFBLoginDialog : ShareKitFBDialog {
    id<ShareKitFBLoginDialogDelegate> _loginDelegate;
}
...
@protocol ShareKitFBLoginDialogDelegate <NSObject>
