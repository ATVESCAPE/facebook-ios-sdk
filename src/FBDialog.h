...
@protocol ShareKitFBDialogDelegate;
...
@interface ShareKitFBDialog : UIView <UIWebViewDelegate> {
    id<ShareKitFBDialogDelegate> _delegate;
    ...
    ShareKitFBFrictionlessRequestSettings* _frictionlessSettings;
 ...
 * The delegate.
 */
@property(nonatomic,assign) id<ShareKitFBDialogDelegate> delegate;
 ...
 */
@protocol ShareKitFBDialogDelegate <NSObject>
 ...
 */
- (void)dialogDidComplete:(ShareKitFBDialog *)dialog;
 ...
 */
- (void)dialogDidNotComplete:(ShareKitFBDialog *)dialog;

/**
 * Called when dialog failed to load due to an error.
 */
- (void)dialog:(ShareKitFBDialog*)dialog didFailWithError:(NSError *)error;
 ...
 */
- (BOOL)dialog:(ShareKitFBDialog*)dialog shouldOpenURLInExternalBrowser:(NSURL *)url;
